...
function Dashboard() {
  ...
  const strategies = [
    { name: 'RSI Oversold Bot', status: 'Active', return: '+12.5%', trades: 24, winRate: '72%' },
    { name: 'MA Crossover', status: 'Active', return: '+8.3%', trades: 18, winRate: '67%' },
    { name: 'Breakout Scanner', status: 'Paused', return: '+5.1%', trades: 12, winRate: '58%' },
  ];
    ...
    <div style={{ padding: '2rem', maxWidth: '1400px', margin: '0 auto', color: 'white' }}>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(4, 1fr)', gap: '1rem', marginBottom: '2rem' }}>
        {[
          ...
          { label: 'Active Strategies', value: '2', change: 'Running' },
        ].map((stat, idx) => (
      ...
      <div style={{ background: '#121212', borderRadius: '8px', padding: '1.5rem', border: '1px solid #222' }}>
        <h3 style={{ fontSize: '1.25rem', color: '#00FF88', marginBottom: '1rem' }}>🤖 Active Strategies</h3>
        <div style={{ display: 'grid', gap: '1rem' }}>
          {strategies.map((strategy, idx) => (
            <div key={idx} style={{ background: '#0A0A0A', padding: '1rem', borderRadius: '6px', border: '1px solid #1a1a1a', display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
              <div>
              ...
              <div style={{ display: 'flex', alignItems: 'center', gap: '2rem' }}>
                ...
                <button style={{ background: strategy.status === 'Active' ? '#FF3B30' : '#00FF88', color: '#0A0A0A', padding: '0.5rem 1rem', borderRadius: '4px', border: 'none', cursor: 'pointer', fontWeight: 'bold', fontSize: '0.85rem' }}>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '2rem' }}>
        ...
        <div style={{ background: '#121212', borderRadius: '8px', padding: '1.5rem', border: '1px solid #222' }}>
          ...
          <div style={{ marginBottom: '1rem' }}>
            ...
            <select style={{ width: '100%', padding: '0.7rem', background: '#0A0A0A', border: '1px solid #333', borderRadius: '6px', color: 'white', fontSize: '0.9rem' }}>
          ...
          <div style={{ marginBottom: '1rem' }}>
            ...
            <input type="text" defaultValue="$10,000" style={{ width: '100%', padding: '0.7rem', background: '#0A0A0A', border: '1px solid #333', borderRadius: '6px', color: 'white', fontSize: '0.9rem' }} />
          </div>
          ...
          {backtestResults ? (
            <>
              <div style={{ display: 'grid', gridTemplateColumns: 'repeat(2, 1fr)', gap: '1rem', marginBottom: '1.5rem' }}>
                {Object.entries(backtestResults).map(([key, value]) => (
                  <div key={key} style={{ background: '#0A0A0A', padding: '1rem', borderRadius: '6px' }}>
                    ...
                    <p style={{ fontSize: '1.5rem', fontWeight: 'bold', color: value.includes('-') ? '#FF3B30' : '#00FF88' }}>
                      {value}
                    </p>
                  </div>
                ))}
              ...
              <div style={{ display: 'flex', gap: '0.5rem' }}>
                <button style={{ flex: 1, padding: '0.7rem', background: '#00FF88', color: '#0A0A0A', border: 'none', borderRadius: '6px', fontWeight: 'bold', cursor: 'pointer' }}>
                  Save Strategy
                </button>
...
function Alerts() {
  const [alerts, setAlerts] = useState([
    { id: 1, symbol: 'AAPL', condition: 'Price > $185', status: 'Active' },
    { id: 2, symbol: 'BTC-USD', condition: 'RSI < 30', status: 'Triggered' },
  ]);
      ...
      <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '2rem' }}>
        <div style={{ background: '#121212', borderRadius: '8px', padding: '1.5rem', border: '1px solid #222' }}>
          ...
          <div style={{ marginBottom: '1rem' }}>
            ...
            <input type="text" placeholder="AAPL" style={{ width: '100%', padding: '0.7rem', background: '#0A0A0A', border: '1px solid #333', borderRadius: '6px', color: 'white', fontSize: '0.9rem' }} />
          </div>
          ...
          <div style={{ marginBottom: '1rem' }}>
            ...
            <input type="text" placeholder="185.00" style={{ width: '100%', padding: '0.7rem', background: '#0A0A0A', border: '1px solid #333', borderRadius: '6px', color: 'white', fontSize: '0.9rem' }} />
          </div>

          <button style={{ width: '100%', padding: '0.9rem', background: 'linear-gradient(135deg, #00FF88 0%, #00CC6F 100%)', color: '#0A0A0A', border: 'none', borderRadius: '6px', fontWeight: 'bold', cursor: 'pointer', fontSize: '1rem' }}>
            Create Alert
          </button>
        </div>
            ...
            {alerts.map((alert) => (
              <div key={alert.id} style={{ background: '#0A0A0A', padding: '1rem', borderRadius: '6px', display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                ...
                <div style={{ display: 'flex', alignItems: 'center', gap: '1rem' }}>
                  ...
                  <button style={{ background: 'transparent', border: '1px solid #FF3B30', color: '#FF3B30', padding: '0.3rem 0.7rem', borderRadius: '4px', cursor: 'pointer', fontSize: '0.8rem' }}>
                    Delete
                  </button>
                </div>
              </div>
