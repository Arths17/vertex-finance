      ...
      <div className="max-w-7xl mx-auto px-6 py-4">
        <div className="flex items-center justify-between">
          ...
          {isHome && (
            <div className="hidden md:flex gap-4">
              <button className="px-6 py-2 text-white hover:text-blue-400 transition-all">Sign In</button>
              <Link to="/terminal" className="px-6 py-2 bg-gradient-to-r from-blue-500 to-cyan-400 text-black font-bold rounded-lg hover:shadow-lg hover:shadow-blue-500/50 transition-all">
                Get Started
              </Link>
            </div>
          )}
        ...
        {isOpen && (
          <div className="md:hidden mt-4 space-y-4 pb-4">
            ...
            {isHome && (
              <Link to="/terminal" className="block px-4 py-2 bg-blue-500 text-white rounded-lg text-center">Get Started</Link>
            )}
          </div>
        )}
      </div>
